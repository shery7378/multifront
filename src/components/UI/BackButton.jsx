...
export default function BackButton({ onBack, iconClasses, showLabel = true, variant = "default" }) {
  ...
  return (
    <motion.button
      ...
      className={`
        group relative inline-flex items-center gap-2 px-4 py-3 rounded-xl
