//src/components/modals/UpdateEmailVerifyCodeModal.jsx
'use client';
import React, { useState } from 'react';
import Modal from '@/components/UI/Modal';
import Button from '@/components/UI/Button';

export default function UpdateEmailVerifyCodeModal({ code, isOpen, onClose, error }) {
    ...
    return (
        ...
        >
            <div className="grid h-full items-center gap-2">
                <div className="flex">
                    <p className=" text-baltic-black font-medium">You’ll use this email to get notifications, sign in, and recover your account.</p>
                </div>
