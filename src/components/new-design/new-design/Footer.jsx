  ...
  return (
    <footer className="bg-[#1E1E1E] text-white font-manrope">
      ...
      <div className="max-w-[1172px] mx-auto px-4 py-14">
        ...
        <div className="lg:flex lg:justify-between gap-10 lg:gap-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
          {/* Brand */}
          <div>
            <img
              src={"/images/new-icons/MultiKonnect.svg"}
              alt="MultiKonnect"
              className="h-6 mb-6"
            />
          ...
          {/* Discover */}
          <div>
            <h3 className="whitespace-nowrap font-semibold text-[22.71px] leading-[24.61px] tracking-[-1.7px] mb-4">
